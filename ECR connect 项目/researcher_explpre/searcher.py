...
class SearchModule(object):
    ...
    def conduct_search(self):
        """
        conduct search and rank search results with distance, and tf-idf(bm25) factors
        :return: search_result_list: a list of ranked ids [id1, id2, ...]
        """
        # corrected_query = Speller(self.search_query)
        corrected_query = self.search_query
...
def find_synonyms_search_comb_by_wordapi(lemma_set):
    headers = {
        ...
        'x-rapidapi-key': "14e2284a6cmshab5f1a76277c3eep1634a6jsna86e012a4679"
    }
